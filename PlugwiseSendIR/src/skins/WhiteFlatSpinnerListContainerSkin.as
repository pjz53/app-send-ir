...
import assets.skins.SpinnerListContainerBackground;
import assets.skins.SpinnerListContainerSelectionIndicator;
import assets.skins.SpinnerListContainerShadow;

import skins.WhiteFlatMobileSkin;
 ...
 */
public class WhiteFlatSpinnerListContainerSkin extends WhiteFlatMobileSkin
{
    //--------------------------------------------------------------------------
    //
    //  Constructor
     ...
     * 
     */
    public function WhiteFlatSpinnerListContainerSkin()
    {
        super();
        ...
        switch (applicationDPI)
        {
			case DPIClassification.DPI_640:
			{
				...
				borderClass = assets.skins.SpinnerListContainerBackground;
				selectionIndicatorClass = assets.skins.SpinnerListContainerSelectionIndicator;
				shadowClass = assets.skins.SpinnerListContainerShadow;
