 ...
 */
public class WhiteFlatMobileSkin extends ActionScriptSkinBase
{
    //--------------------------------------------------------------------------
    //
    //  Class constants
     ...
     */
    mx_internal static const MOBILE_THEME_DARK_COLOR:uint = 0xFFFFFF;
    
    /**
     *  @private
     *  Default <code>chromeColor</code> for the mobile theme.
     */
    mx_internal static const MOBILE_THEME_LIGHT_COLOR:uint = 0xFFFFFF;
    
    /**
     *  @private
     *  Default symbol color for <code>symbolColor</code> style.
     */
    mx_internal static const DEFAULT_SYMBOL_COLOR_VALUE:uint = 0x7D7D7D;
     ...
     * 
     */
    public function WhiteFlatMobileSkin()
    {
